...
- **94 engine tests** (99 including the separate Tauri shell workspace), no network or
  CLI login required.
...
- **No CI.** The repository has no workflows, so the 94 tests run only by hand. This
