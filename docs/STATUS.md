...
- **115 engine tests** (123 including the separate Tauri shell workspace), no network or
  CLI login required.
...
- **No CI.** The repository has no workflows, so the 115 tests run only by hand. This
