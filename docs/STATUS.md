...
- **101 engine tests** (106 including the separate Tauri shell workspace), no network or
  CLI login required.
...
- **No CI.** The repository has no workflows, so the 101 tests run only by hand. This
